#!/usr/bin/env python3
"""
Replace 7c869e623185407e40c92f19b8dd528578ffe403 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "7c869e623185407e40c92f19b8dd528578ffe403" not in text:
    continue

  new_text = text.replace("7c869e623185407e40c92f19b8dd528578ffe403", SHORT_SHA)
  if new_text != text:
