#!/usr/bin/env python3
"""
Replace abfc2eb2889bb550f8fc56d2f3eaad53b42caaa1 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "abfc2eb2889bb550f8fc56d2f3eaad53b42caaa1" not in text:
    continue

  new_text = text.replace("abfc2eb2889bb550f8fc56d2f3eaad53b42caaa1", SHORT_SHA)
  if new_text != text:
