#!/usr/bin/env python3
"""
Replace b19a0bb598f41e98531e947e97c6053525bda3f6 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "b19a0bb598f41e98531e947e97c6053525bda3f6" not in text:
    continue

  new_text = text.replace("b19a0bb598f41e98531e947e97c6053525bda3f6", SHORT_SHA)
  if new_text != text:
