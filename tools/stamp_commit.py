#!/usr/bin/env python3
"""
Replace c75d2ebe36eca41ee895c03071fe1d34a4adaae1 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "c75d2ebe36eca41ee895c03071fe1d34a4adaae1" not in text:
    continue

  new_text = text.replace("c75d2ebe36eca41ee895c03071fe1d34a4adaae1", SHORT_SHA)
  if new_text != text:
