#!/usr/bin/env python3
"""
Replace a5921f74b3950d69e529ce5ff514f7d248b449b9 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "a5921f74b3950d69e529ce5ff514f7d248b449b9" not in text:
    continue

  new_text = text.replace("a5921f74b3950d69e529ce5ff514f7d248b449b9", SHORT_SHA)
  if new_text != text:
