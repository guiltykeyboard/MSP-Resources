#!/usr/bin/env python3
"""
Replace 9726d3fa1e6201c5dea1466abffe935ea261071b placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "9726d3fa1e6201c5dea1466abffe935ea261071b" not in text:
    continue

  new_text = text.replace("9726d3fa1e6201c5dea1466abffe935ea261071b", SHORT_SHA)
  if new_text != text:
