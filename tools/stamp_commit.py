#!/usr/bin/env python3
"""
Replace 09fc509020ccd00eaab431cc9c2cabb9eb6a0ad3 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "09fc509020ccd00eaab431cc9c2cabb9eb6a0ad3" not in text:
    continue

  new_text = text.replace("09fc509020ccd00eaab431cc9c2cabb9eb6a0ad3", SHORT_SHA)
  if new_text != text:
