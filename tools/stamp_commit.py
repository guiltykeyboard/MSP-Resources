#!/usr/bin/env python3
"""
Replace d4f518972b3d9ec8c772397caf09d74e7a6cfac4 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "d4f518972b3d9ec8c772397caf09d74e7a6cfac4" not in text:
    continue

  new_text = text.replace("d4f518972b3d9ec8c772397caf09d74e7a6cfac4", SHORT_SHA)
  if new_text != text:
