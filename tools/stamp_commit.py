#!/usr/bin/env python3
"""
Replace d54c35787ed2f074a671e00b21f3dde9abb81786 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "d54c35787ed2f074a671e00b21f3dde9abb81786" not in text:
    continue

  new_text = text.replace("d54c35787ed2f074a671e00b21f3dde9abb81786", SHORT_SHA)
  if new_text != text:
