#!/usr/bin/env python3
"""
Replace 0fb47aa203670ef7bdcb7865aa6de8a5cf386962 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "0fb47aa203670ef7bdcb7865aa6de8a5cf386962" not in text:
    continue

  new_text = text.replace("0fb47aa203670ef7bdcb7865aa6de8a5cf386962", SHORT_SHA)
  if new_text != text:
