#!/usr/bin/env python3
"""
Replace 08d605a411c9df4852d0f8d6f5f0b9a11820fec8 placeholders in scripts with the current commit's short SHA.
...
for path in REPO_ROOT.rglob("*"):
  ...
  if "08d605a411c9df4852d0f8d6f5f0b9a11820fec8" not in text:
    continue

  new_text = text.replace("08d605a411c9df4852d0f8d6f5f0b9a11820fec8", SHORT_SHA)
  if new_text != text:
